...
public interface IResizingHandler<T extends Parent> {

    IRelocater<T> getRelocater();

    IResizingGuideController getController(CardinalPoint cardinalPoint);

    List<IProperty> getResizingProperties();
