...
public abstract class FluidonFileDataObject extends MultiDataObject implements IFluidonFileDataObject {

    public FluidonFileDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
    }
